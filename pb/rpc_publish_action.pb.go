...
// 	protoc        v3.12.4
// source: rpc_publish_action.proto
...
func (x *DouyinPublishActionRequest) Reset() {
	*x = DouyinPublishActionRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rpc_publish_action_proto_msgTypes[0]
...
func (*DouyinPublishActionRequest) Descriptor() ([]byte, []int) {
	return file_rpc_publish_action_proto_rawDescGZIP(), []int{0}
}
...
func (x *DouyinPublishActionResponse) Reset() {
	*x = DouyinPublishActionResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rpc_publish_action_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinPublishActionResponse) Descriptor() ([]byte, []int) {
	return file_rpc_publish_action_proto_rawDescGZIP(), []int{1}
}
...
var File_rpc_publish_action_proto protoreflect.FileDescriptor

var file_rpc_publish_action_proto_rawDesc = []byte{
	0x0a, 0x18, 0x72, 0x70, 0x63, 0x5f, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x5f, 0x61, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x03, 0x69, 0x64, 0x6c, 0x22,
	0x5c, 0x0a, 0x1a, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68,
...
var (
	file_rpc_publish_action_proto_rawDescOnce sync.Once
	file_rpc_publish_action_proto_rawDescData = file_rpc_publish_action_proto_rawDesc
)

func file_rpc_publish_action_proto_rawDescGZIP() []byte {
	file_rpc_publish_action_proto_rawDescOnce.Do(func() {
		file_rpc_publish_action_proto_rawDescData = protoimpl.X.CompressGZIP(file_rpc_publish_action_proto_rawDescData)
	})
	return file_rpc_publish_action_proto_rawDescData
}

var file_rpc_publish_action_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_rpc_publish_action_proto_goTypes = []interface{}{
...
var file_rpc_publish_action_proto_depIdxs = []int32{
...
func init() { file_rpc_publish_action_proto_init() }
func file_rpc_publish_action_proto_init() {
	if File_rpc_publish_action_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_rpc_publish_action_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_rpc_publish_action_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_rpc_publish_action_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_rpc_publish_action_proto_goTypes,
		DependencyIndexes: file_rpc_publish_action_proto_depIdxs,
		MessageInfos:      file_rpc_publish_action_proto_msgTypes,
	}.Build()
	File_rpc_publish_action_proto = out.File
	file_rpc_publish_action_proto_rawDesc = nil
	file_rpc_publish_action_proto_goTypes = nil
	file_rpc_publish_action_proto_depIdxs = nil
}
